...
net.load_state_dict(torch.load('./pretrained/{}.pth'.format('mnm2019_with_new')))
net.to(device)
...
print('RMS: {}'.format(torch.sqrt(total_error/len(dataloader.dataset))))
print('elapsed time: {}'.format(time.time()-start))
print('time per image: {}'.format((time.time()-start)/len(dataloader.dataset)))
print('------'*4)
